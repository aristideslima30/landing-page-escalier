  ...
  return (
    <footer className="bg-black border-t border-purple-900/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-md flex items-center justify-center">
                <div className="w-6 h-6 bg-white/20 rounded-sm grid grid-cols-2 gap-0.5">
              ...
              <span className="text-white font-bold text-2xl">Escalier Tech</span>
            </div>
            <p className="text-gray-300 leading-relaxed max-w-md">
              Transformamos empresas com automação inteligente e marketing digital de alta performance. 
              Soluções inovadoras baseadas em Inteligência Artificial para maximizar resultados.
            </p>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>techescalier@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <MessageCircle className="w-5 h-5 text-green-400" />
                <span>(88) 99415-0021</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <MapPin className="w-5 h-5 text-orange-400" />
                <span>Sobral, CE - Brasil</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-purple-900/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-6 mb-4 md:mb-0">
              <a href="#" className="w-10 h-10 bg-purple-600/20 border border-purple-500/30 rounded-lg flex items-center justify-center text-purple-400 hover:bg-purple-600/30 hover:text-purple-300 transition-all duration-300">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8 text-sm text-gray-400">
              <span>© 2024 Escalier Tech. Todos os direitos reservados.</span>
